...
-   Aktuelle Metaanalyse [@filderman2021] berichtet 
    ...
    -   moderate positive Effekte auf motivationale Überzeugungen *(g = .48; 95% CI = \[.17, .79\])* 
        -   expectancy-Komponente: -.74 < *g* < 3.68 
        -   value-Komponente: -.43 < *g* < 1.25

. . .

-   Nur Interventionsstudien mit Lehramtsstudierenden: 
    -   data literacy: moderate bis große positive signifikante Effekte [@merk2020; @reeves2017; @reeves2018] 
...
Um Evidenz nicht nur gegen sondern auch für einen Nulleffekt generieren zu können: Anwendung von Bayesianischem Hypothesentesten für Strukturgleichungsmodelle [@gu2019]

##  {.smaller}

### Ergebnisse \| visualisiert {.smaller}

![dargestellt jeweils: MW, ±1 SD](img/Plot_Effects_of_Intervention.png){fig-align="left"}
